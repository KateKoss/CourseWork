namespace CourseWork
{
    partial class AddNewField
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.course_workDataSet = new CourseWork.Course_workDataSet();
            this.label3 = new System.Windows.Forms.Label();
            this.bindingSource1 = new System.Windows.Forms.BindingSource(this.components);
            this.cropTableAdapter = new CourseWork.Course_workDataSetTableAdapters.CropTableAdapter();
            ...
            // button2
            // 
            this.button2.Location = new System.Drawing.Point(148, 141);
    ...
    "rseWork\\bin\\Debug\\Course_work.mdf;Integrated Security=True;Connect Timeout=30";
            ...
            this.label2.Text = "Заповніть всі поля:";
            // 
            // comboBox1
            // 
            this.comboBox1.DataBindings.Add(new System.Windows.Forms.Binding("SelectedValue", this.course_workDataSet, "Crop.CropName", true));
            this.comboBox1.DisplayMember = "Crop.CropId";
            ...
            this.comboBox1.ValueMember = "Crop.CropId";
            // 
            // course_workDataSet
            // 
            ...
            this.label3.Text = "Культура";
            // 
            // bindingSource1
            // 
            this.bindingSource1.DataSource = this.course_workDataSet;
            ...
            this.Text = "Нове поле";
            this.Load += new System.EventHandler(this.AddNewField_Load_1);
        ...
        private Course_workDataSetTableAdapters.CropTableAdapter cropTableAdapter;
    }
}